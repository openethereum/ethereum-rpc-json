...
export default {
  version: {
    ...
    params: [],
    returns: {
      type: String, desc: 'The current whisper protocol version'
    },
    inputFormatters: [],
  ...
  post: {
    ...
    params: [
      {
        type: Object, desc: 'The whisper post object:',
        details: {
          from: {
            type: Data, desc: '60 Bytes - (optional) The identity of the sender'
          },
          to: {
            type: Data, desc: '60 Bytes - (optional) The identity of the receiver. When present whisper will encrypt the message so that only the receiver can decrypt it'
          },
          topics: {
    ...
    returns: {
      type: Boolean, desc: '`true` if the message was send, otherwise `false`'
    },
    inputFormatters: [
      'inputPostFormatter'
    ],
  ...
  newIdentity: {
    ...
    params: [],
    returns: {
      type: Data, desc: '60 Bytes - the address of the new identiy'
    },
    inputFormatters: [],
    outputFormatter: null
  },
  hasIdentity: {
    ...
    params: [
      { type: Data, desc: '60 Bytes - The identity address to check' }
    ],
    returns: {
      type: Boolean, desc: '`true` if the client holds the privatekey for that identity, otherwise `false`'
    },
    inputFormatters: [],
    outputFormatter: null
  },
  ...
  addToGroup: {
    desc: '(?)',
    params: [
      { type: Data, desc: '60 Bytes - The identity address to add to a group (?)' }
    ],
    returns: {
      type: Boolean, desc: '`true` if the identity was successfully added to the group, otherwise `false` (?)'
    },
    inputFormatters: [],
    outputFormatter: null
  },
  newFilter: {
    ...
    params: [
      {
        ...
        details: {
          to: {
            type: Data, desc: '60 Bytes - (optional) Identity of the receiver. *When present it will try to decrypt any incoming message if the client holds the private key to this identity.*'
          },
          topics: {
    ...
    returns: {
      type: Quantity, desc: 'The newly created filter'
    },
    inputFormatters: [],
    outputFormatter: null
  },
  ...
  getFilterChanges: {
    ...
    returns: {
      type: Array, desc: 'Array of messages received since last poll'
    },
    inputFormatters: [],
    outputFormatter: null
  },
